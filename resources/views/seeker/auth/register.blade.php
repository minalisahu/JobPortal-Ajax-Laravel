            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="firstname" type="text"
                                                ...
                                                placeholder="Enter first name here" required autocomplete="firstname" autofocus>
                                            @error('firstname')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="lastname" type="text"
                                                ...
                                                placeholder="Enter last name here" required autocomplete="lastname" autofocus>
                                            @error('lastname')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input id="email" type="text"
                                        ...
                                        value="{{ old('email') }}" required placeholder="Enter email here" autocomplete="email">
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input id="username" type="text"
                                        ...
                                        value="{{ old('username') }}" required placeholder="Enter username here"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="password-confirm" type="password" class="form-control"
                                                name="password_confirmation" required placeholder="Enter confirm password here"
                                                autocomplete="new-password">
                        ...
                        <input type="hidden" value='2' name="access" >
                        <input type="hidden" value='a' name="companyname" >
