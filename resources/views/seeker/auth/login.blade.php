            ...
            <form class="user" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    <input type="username" class="form-control form-control-user @error('username') is-invalid @enderror"
                        name="username" value="{{ old('username') }}" required placeholder="Enter username here...">
                    @error('username')
                ...
                <button class="btn btn-primary btn-user btn-block">
                  ...
                  <a href="{{route('register-page')}}" class="btn btn-primary btn-user btn-block">{{__('Sign-up')}}</a>
                <hr>
